...
class OtpVerifyChangePhoneController extends GetxController {
  late TextEditingController codecontroller = TextEditingController();
  final ChangePhoneController controller = Get.find();
  ...
  Future<void> otpVerifyChangePhone() async {
    if (!verfiykey.currentState!.validate()) {
      return;
    }
    ...
    try {
      ...
      var response = await http.put(
        Uri.parse('$apiUrl/verify-new-phone'),
        headers: {
