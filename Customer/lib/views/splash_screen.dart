            ...
            children: [
              Row(
                ...
                children: [
                  Opacity(
                      opacity: w3,
                      child: const Text('أسرع', style: txtStyle)),
                  const SizedBox(width: 16),
                  Opacity(
                      opacity: w2,
                      child: const Text('أوفر', style: txtStyle)),
                  const SizedBox(width: 16),
                  Opacity(
                      opacity: w1,
                      child: const Text('أسهل', style: txtStyle)),
                ],
              ),
                  ...
                  children: [
                    AnimatedBuilder(
                      ...
                      builder: (_, __) => CustomPaint(
                        ...
                        painter:
                            _SmileCurvePainter(progress: _curveCtrl.value),
                      ),
                    ),
                    const Positioned(
                      right: -8,
