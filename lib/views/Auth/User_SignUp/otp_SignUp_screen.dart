...
import 'package:piaggio_driver/logic/controller/otp_verify_SignUp_controller.dart';
...
class OtpScreenSignup extends StatelessWidget {
  ...
  final OtpVerifySignupController controller =
      Get.put(OtpVerifySignupController());
                ...
                children: [
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.error_outline,
                                  color: AppThemes.light.colorScheme.error, size: 20),
                  ...
                  Obx(() => Button(
                        ...
                        onPressed: () async {
                          ...
                          controller.successMessage.value = "";
                          final result =
                              await controller.otpVerifySignupController();
                          if (result != null) {
                            controller.errorMessage.value = result;
                          }
                        },
